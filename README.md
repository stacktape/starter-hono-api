...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-hono-api)

- Lightweight HTTP API built with [Hono](https://hono.dev/), an ultrafast web framework.
- Runs serverlessly in [AWS Lambda](https://docs.stacktape.com/compute-resources/lambda-functions/) behind an
...
```bash
stacktape init --starterId hono-api
```
